            ...
            new daum.Postcode({
                oncomplete: function(data) {
                    ...
                    if(data.userSelectedType === 'R'){
                        ...
                        // var a = document.querySelector("선택자").value = extraAddr;
                    ...
                    document.querySelector("input[name=customer_post]").value = data.zonecode;
                    document.querySelector("input[name=customer_basic_address").value = addr;
                    // 커서를 상세주소 필드로 이동한다.
                    document.querySelector("input[name=customer_extra_address]").focus();
	...
	<div>
		...
		<div>
			<ul>
				<li>
					<label>우편번호</label>
					<input type="text" name="customer_post"  value="<%=cdto.getCustomer_post()%>" readonly="readonly">
					<input type="button" onclick="postcode()" value="우편번호 찾기">
				</li>
				<li>
					<label>기본주소</label>
						<input type="text" name="customer_basic_address"  value="<%=cdto.getCustomer_basic_address()%>"  readonly="readonly">
				</li>
				<li>
					<label>상세주소</label>
						<input type="text" name="customer_extra_address" value="<%=cdto.getCustomer_extra_address()%>">
				</li>
