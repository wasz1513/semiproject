...
<form action="change_info.do" method="post"
	...
	<div class="row-multi col-2">
		...
		<div class="col-2-second">
			...
			<div>
				닉네임 : <input type="text" name="customer_nickname"
	...
	<div>
		폰번호 : <input type="text" name="customer_phone"
			value="<%=dto.getCustomer_phone()%>">
	</div>
	<div>
		이메일 : <input type="text" name="customer_email"
			value="<%=dto.getCustomer_email()%>">
	</div>
	<div>
		우편번호 : <input type="text" name="customer_post"
			value="<%=dto.getCustomer_post()%>">
	</div>
	<div>
		기본주소 : <input type="text" name="customer_basic_address"
			value="<%=dto.getCustomer_basic_address()%>">
	</div>
	<div>
		상세주소 : <input type="text" name="customer_extra_address"
			value="<%=dto.getCustomer_extra_address()%>">
	</div>
	<div>
