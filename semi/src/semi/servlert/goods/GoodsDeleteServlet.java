...
@WebServlet(urlPatterns = "/goods/delete.do")
...
protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			String customer_grade = (String) req.getSession().getAttribute("customer_grade");
			boolean isAdmin = customer_grade.equals("관리자");
			boolean isMine = customer_grade.equals(dto.getCustomer_id());
